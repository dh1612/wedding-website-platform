      ...
      <header className="sticky top-0 z-30 border-b border-black/5 bg-white/85 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-6 py-4 lg:px-8">
          ...
          <details className="md:hidden">
            ...
            <div className="absolute left-6 right-6 top-[calc(100%+0.75rem)] rounded-[1.5rem] border border-black/6 bg-white p-4 shadow-[0_20px_50px_rgba(52,35,24,0.12)]">
              <div className="flex flex-col gap-2">
                ...
                <a href="#couple-area" className="rounded-xl px-4 py-3 text-sm text-[#4e453f] hover:bg-[#faf7f2]">
                  Couple Area
                </a>
                <a href="#templates" className="rounded-xl px-4 py-3 text-sm text-[#4e453f] hover:bg-[#faf7f2]">
                  Brochure
                </a>
                <Link
                  href="/get-started"
